...
void main() {
    ...
    //     As before, convert the diffuseTex values to linear space, but there's no need to do so for the 
    //     gloss, normal, and specular maps.
    
    // TODO: Part 3 - Convert to sRGB before writing (using LinearTosRGB)
