...
import vertShader from './shader/part4.vert.glsl';
import fragShader from './shader/part4.frag.glsl';
...
function setupGui() {
    ...
    gui.add(guiState, 'showNormals').name("Show Normals:").onFinishChange( (value : boolean) => helpers.normalHelper.visible = value );
